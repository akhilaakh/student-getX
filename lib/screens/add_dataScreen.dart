          ...
          children: [
            ...
            CircleAvatar(
              ...
              backgroundImage: _image != null
                  ? FileImage(_image!)
                  : AssetImage(
                      'assets/WhatsApp Image 2024-09-19 at 15.47.52_b821d333.jpg',
                    ) as ImageProvider,
            ),
            ElevatedButton(
              onPressed: _getImage,
              child: const Text(
                'Pick Image',
                style: TextStyle(color: const Color.fromARGB(255, 2, 33, 57)),
              ),
            ),
              ...
              children: [
                ...
                TextButton(
                  style: TextButton.styleFrom(
                    backgroundColor: Color.fromARGB(255, 231, 51, 69),
                  ),
                  onPressed: () {
